...
import org.client.gui.Home;
import org.client.gui.Login;
import org.networking.rpcprotocol.ProjectServicesRpcProxy;
...
public class StartRpcClient extends Application {
    ...
    public void start(Stage primaryStage) throws IOException, ProjectException {
        ...
        FXMLLoader mainLoader = new FXMLLoader(
                StartRpcClient.class.getClassLoader().getResource("hello-view.fxml")
        );
