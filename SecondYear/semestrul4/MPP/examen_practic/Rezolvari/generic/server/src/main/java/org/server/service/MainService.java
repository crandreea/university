...
public class MainService implements ProjectServices {
    ...
    public MainService(Service<Integer, User> userService, IGameRepo gameRepository, IPositionRepo positionRepository, IConfigurationRepo configurationRepository) {
