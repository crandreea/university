...
//    ResponseEntity<?> getGame(@PathVariable Long playerId, @PathParam("") String gameStatus) {
//        Optional<User> user = userRepo.findById(playerId);
//        if (user.isPresent()) {
//            Iterable<Game> games = gameRepo.findGamesForUserByStatus(user.get(), gameStatus);
