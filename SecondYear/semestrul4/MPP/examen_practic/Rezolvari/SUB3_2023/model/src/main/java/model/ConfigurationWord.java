...
@Table(name = "configurationwords")
public class ConfigurationWord extends Entity<Integer> {
    ...
    public ConfigurationWord(Configuration configuration, Word word, Integer word_number) {
