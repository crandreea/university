...
void test_sortare(){
        ...
        const vector<Disciplina> list = service.sortareDisciplineDenumire();
        const vector<Disciplina> list2 = service.sortareDisciplineOre();
        const vector<Disciplina> list3 = service.sortareDisciplineTipProf();
...
void test_contract(){
    ...
    string fisier_csv = "/Users/croitoruandreea/Desktop/ANUL1/sem2/OOP/LAB/Lab10/test.csv";
    string fisier_html = "/Users/croitoruandreea/Desktop/ANUL1/sem2/OOP/LAB/Lab10/test.html";
    string fisier_alt = "/Users/croitoruandreea/Desktop/ANUL1/sem2/OOP/LAB/Lab10/test.txt";
...
void test_fisier() {
    DisciplinaRepoFile repo{"/Users/croitoruandreea/Desktop/ANUL1/sem2/OOP/LAB/Lab10/test.txt"};
    Validator valid;
    Contract cos;
    DisciplinaService service{repo, valid, cos};
